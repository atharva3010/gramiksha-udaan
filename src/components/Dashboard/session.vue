...
<v-list-tile v-for="(student , index) in Marks" :key="index"> 
  <v-list-tile-avatar><div style="color:white;border-radius:50%;font-weight:bold;height:25px;width:25px;background-color:#424242;" >{{index+1}}</div></v-list-tile-avatar>
